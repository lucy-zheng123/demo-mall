<template>
 <div id="profile">
    ...
    <UserInfo>
     <template #user-icon>
       <img src="~assets/img/profile/1_meitu_1.png" alt="头像" class="user-icon"> </template>
    </UserInfo>
   ...
   <a href="https://github.com/lucy-zheng123" class="github">GitHub</a>
  </div>
...
<script>
  ...
  import NavBar from 'components/common/navbar/NavBar'
	export default {
		name: "profile",
    components: {
		  UserInfo, ListView, NavBar,Scroll
    },
    data: function () {
		  return {
		    orderList: [
        ...
        serviceList: [
          {icon: '#service', iconColor: '#ff8198', info: '我的购物车',path:'/cart'},
